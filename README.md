...
<p align="center">
  ...
  写给不懂代码、但要指挥 AI 干活的人。目标是"看懂"，不是学会。
</p>
...
顺带点破一句：上面把 SDK 说成“外卖平台 + 骑手服务”，听着顺，其实是错的——骑手只管配送，不算接入工具。
...
└── references/
    ├── analogy-handbook.md      # 术语手册索引：按任务分流到各领域手册
...
主文件只留每次都要守的规则；长尾词典与完整案例按任务加载，免得 AI 每回解释前都得先把整本手册从头读一遍。
